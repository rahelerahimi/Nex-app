              ...
              <SwiperSlide key={item.id} >
                <Link href={`/movies/${item.id}`}>
                  <div key={item.id} className={styles.parentMap} >
                    <Image width={200} height={300} priority={true} alt={item.title} src={item.poster} className={styles.imgSlider} />
                    <div className={styles.absoluteMap}  >
                      <p className={styles.countryMap}>country : {item.country}</p>
