...
const CommentGetMap: FC<CommentGetMapProps> = ({
  deleteComment,
  editComment,
  comments,
  fetchComments,
  ...
  const productComments = comments.filter(
    (comment: CommentData) => comment.title === title
  );
        ...
        productComments.map((comment: CommentData) => (
          <div key={comment.id} className={styles.parentComment}>
            <div className={styles.flexComment}>
              ...
              <div>
                <span>|</span>{" "}
                <button onClick={() => editComment(comment, formiksetvalues)}>
                  <FaRegEdit />
                </button>
                <span>|</span>
                <button
                  onClick={() => deleteComment(comment.id, fetchComments)}
                >
                  <RiDeleteBinLine />
                </button>
              </div>
